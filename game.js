...
class Game{
  ...
  async startGame(){
    ...
    play(){
           ...
           for (var plr in allPlayers) {
            index=index+1
              ...
              horses[index-1].x=x
               ...
               if(this.upstate[index-1]>0)
                 y = y- 10*this.upstate[index-1];
               if(this.downstate[index-1]>0)
                 y = y - 10*this.downstate[index-1];
      ...
      if(keyDown(UP_ARROW)&&player.index!==null&& this.upstate[player.index-1]==0 )
      {
        ...
        {
          this.upstate[player.index-1]=-1;
          this.downstate[player.index-1]=10
          console.log("jump ending");
        }
      
      if(this.downstate[player.index-1]>0)
        this.downstate[player.index-1]-=1;
      else if(this.downstate[player.index-1]==0)
        {
          this.upstate[player.index-1]=0;
          this.downstate[player.index-1]=-1;
        }
